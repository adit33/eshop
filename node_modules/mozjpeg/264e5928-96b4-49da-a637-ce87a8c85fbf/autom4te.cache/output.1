...
@%:@ Generated by GNU Autoconf 2.69 for mozjpeg 3.1.
@%:@ 
@%:@ 
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures mozjpeg 3.1 to adapt to many kinds of systems.
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of mozjpeg 3.1:";;
   esac
  cat <<\_ACEOF
...
It was created by mozjpeg $as_me 3.1, which was
...
ac_log="
This file was extended by mozjpeg $as_me 3.1, which was
generated by GNU Autoconf 2.69.  Invocation command line was
